...
return array(
	...
	'quicklinks:add:title' => "Add a QuickLink",
	'quicklinks:edit:url' => "Website URL",
	'quicklinks:edit:required' => "Fields marked with a * are required",
	
	// actions
	'quicklinks:action:toggle:success:add' => "Quicklink added",
	'quicklinks:action:toggle:success:remove' => "QuickLink removed",
